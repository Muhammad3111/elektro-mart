...
export function CatalogBannerForm({ banner, onSubmit, onCancel, loading }: CatalogBannerFormProps) {
  const { t } = useLanguage();
  ...
  const [imagePreview, setImagePreview] = useState<string>(banner?.coverImage || "");
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              {imagePreview ? (
                <div className="relative w-32 h-32 border rounded-lg overflow-hidden">
                  <S3Image src={imagePreview} alt="Banner preview" fill className="object-cover" />
          ...
          <div className="flex gap-3">
            <Button type="submit" disabled={loading} className="flex-1">
              {loading ? t("Saqlanmoqda...", "Сохранение...") : banner ? t("Yangilash", "Обновить") : t("Qo'shish", "Добавить")}
            </Button>
