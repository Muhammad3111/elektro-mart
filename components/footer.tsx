...
export function Footer() {
    ...
    return (
        <footer className="bg-primary/10 rounded-lg p-6 mt-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground italic">
                            {t(
                                "Yorug'lik va quvvat manbaingiz",
                                "Ваш источник света и энергии"
                            )}
                        </p>
                        <div className="mt-4">
                    ...
                    <div>
                        ...
                        <div className="space-y-3 text-sm">
                            ...
                            <div className="flex items-start gap-2">
                                ...
                                <span>
                                    {t(
                                        "O'zbekiston, Toshkent, Shayxontoxir tumani, Taxtapul, To'raqurgon ko'chasi 12b, Mo'ljal: Malika bozori",
