        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <Link href="/" className="flex items-center gap-2 mb-3 cursor-pointer">
              ...
              <span className="text-xl font-bold">Sobirov</span>
            </Link>
            <p className="text-sm text-muted-foreground italic">
              {t("Yorug'lik va quvvat manbaingiz", "Ваш источник света и энергии")}
            </p>
          </div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div>
                ...
                <div className="flex space-x-3">
                  <Link href="https://t.me/electrawire" target="_blank" className="text-muted-foreground hover:text-primary transition-colors cursor-pointer">
                  ...
                  <Link href="https://instagram.com/electrawire" target="_blank" className="text-muted-foreground hover:text-primary transition-colors cursor-pointer">
                    <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
